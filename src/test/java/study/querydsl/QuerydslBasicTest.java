...
public class QuerydslBasicTest {
    ...
    public void startJPQL() {
        ...
        assertThat(findJPQL.getUsername()).isEqualTo("member1");
    }
...
//        List<Member> content = results.getResults();
    ...
    @Test
    public void fectchJoinNo() throws Exception {
        //given
        em.flush();
        em.clear();
    ...
    @Test
    public void fectchJoinUse() throws Exception {
        //given
        em.flush();
        em.clear();
...
//                                member.username
//                        )))
                .where(member.username.upper().like("MEMBER_"))
//                .where(member.username.upper().startsWith("MEMBER"))
                .fetch();
